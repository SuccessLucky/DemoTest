...
/**
 * Created by xieyanhao on 16/10/12.
 */
public class SceneReq {
    ...
    private List<SceneDetailBean> scene_details = new ArrayList<>();
    ...
    public List<SceneDetailBean> getScene_details() {
        return scene_details;
    }

    public void setScene_details(List<SceneDetailBean> scene_details) {
