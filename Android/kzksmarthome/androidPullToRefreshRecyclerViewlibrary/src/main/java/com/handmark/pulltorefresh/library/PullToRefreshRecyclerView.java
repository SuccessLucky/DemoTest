...
public class PullToRefreshRecyclerView extends PullToRefreshBase<RecyclerView> {
    ...
    protected boolean isReadyForPullStart() {
        ...
        if (firstVisiblePosition == 0) {
            RecyclerView.LayoutParams rrr = (RecyclerView.LayoutParams) mRefreshableView.getChildAt(0).getLayoutParams();
            return mRefreshableView.getChildAt(0).getTop() == (mRefreshableView.getPaddingTop() + rrr.topMargin);
        }
        return false;
    }
