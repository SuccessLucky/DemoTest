 ...
 */
public class DeviceRightsSelectListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DeviceRightsSelectListAdapter(Context context) {
    ...
    public DeviceRightsSelectListAdapter(Context context, List<DeviceInfo> deviceList) {
        this(context);
        this.deviceList = deviceList;
    }
    ...
    class DeviceViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onClick() {
            DeviceInfo clicked = deviceList.get(getPosition());
            if (null == clicked) {
                return;
            }
