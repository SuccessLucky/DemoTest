...
/**
 * @Title: GetAllDeviceListResponse
 * @Description: 获取网关下所有设备列表返回
 * @author laixj
 * @date 2016/9/18 14:50
 * @version V1.0
 */
public class GetAllDeviceListResponse1 extends BaseResponse {
    /**
     * success : true
    ...
    private List<SceneDetailInfo> result;
    ...
    public List<SceneDetailInfo> getResult() {
        return result;
    }

    public void setResult(List<SceneDetailInfo> result) {
        this.result = result;
    }
