...
/**
 * @Title: AddSceneRequestParam
 * @Description: 增加场景请求参数
 * @author laixj
 * @date 2016/10/15 6:41
 * @version V1.0
 */
public class AddSceneRequestParam {
    /**
     * scene_id : 0
     * name : 回家
     * image : 0001.jpg
     * scene_details : [{"scene_detail_id":0,"device_id":1,"device_state1":1,"device_state2":0,"device_state3":0,"other_status":"30"},{"scene_detail_id":0,"device_id":2,"device_state1":1,"device_state2":0,"device_state3":0,"other_status":"30"}]
     */
