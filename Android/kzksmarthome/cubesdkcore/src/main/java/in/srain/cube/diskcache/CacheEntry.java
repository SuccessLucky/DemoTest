...
public class CacheEntry {
    ...
    public void setUnderEdit(boolean val) {
        this.mIsUnderEdit = val;
    }
    ...
    /**
     * Returns a new unbuffered output stream to write the value If the underlying output stream encounters errors when writing to the
     * filesystem, this edit will be aborted when {@link #commit} is called. The returned output stream does not throw IOExceptions.
     */
    ...
    public void setIsUnderEdit(boolean flag){
        mIsUnderEdit = true;
    }

    /*
     * Aborts this edit. This releases the edit lock so another edit may be started on the same mKey.
     */
