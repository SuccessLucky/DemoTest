...
public interface ImageLoadHandler {
     ...
     * After image is loaded.
     */
    void onLoadThumbFinish(ImageTask imageTask, CubeImageView cubeImageView, BitmapDrawable drawable);
     ...
     * @param drawable
     */
    void onLoadDrawable(ImageTask imageTask, CubeImageView cubeImageView, BitmapDrawable drawable);
