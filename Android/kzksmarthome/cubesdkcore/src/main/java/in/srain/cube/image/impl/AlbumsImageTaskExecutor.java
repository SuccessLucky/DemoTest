 ...
 */
public class AlbumsImageTaskExecutor implements ImageTaskExecutor {

    private static final TimeUnit KEEP_ALIVE_TIME_UNIT;
    private static final int KEEP_ALIVE_TIME = 1;

    private static int sNUMBER_OF_CORES = 1;
    private static AlbumsImageTaskExecutor sInstance = null;
    ...
    static {
        ...
        sInstance = new AlbumsImageTaskExecutor();
    }

    public static AlbumsImageTaskExecutor getInstance() {
        return sInstance;
    }
    ...
    private AlbumsImageTaskExecutor() {
