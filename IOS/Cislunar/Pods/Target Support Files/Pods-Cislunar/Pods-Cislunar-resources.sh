...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/XWHUDManager/XWHUDManager.bundle"
  install_resource "${PODS_ROOT}/mobAPI/MobProducts/Sample/MobAPIDemo/Sample/Sources/MobAPI.bundle"
fi
