...
{
    return [EZOPENSDK handleOpenUrl:url delegate:self];
}

- (BOOL) application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    return [EZOPENSDK handleOpenUrl:url sourceApplication:sourceApplication annotation:annotation delegate:self];
}
