...
-(id)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        [self addConstraint:[NSLayoutConstraint constraintWithItem:_calView
        ...
        [self addConstraint:[NSLayoutConstraint constraintWithItem:_calView
                                                        ...
                                                        multiplier:1.0
                                                          constant:0]];
        _bottomGapCts=[NSLayoutConstraint constraintWithItem:_calView
...
//        _calView.layer.cornerRadius = 8;
//        _calView.layer.borderColor = [UIColor redColor].CGColor;
//        _calView.layer.borderWidth = 1.0;
    }
    return self;
}
